...
public class Odometer implements Runnable {
  ...
  /** The left torque value. */
  private volatile double leftTorque;
  
  /** The right torque value. */
  private volatile double rightTorque;
  
  /** The average torque value. */
  private volatile double aveTorque;
  
  /** The torque array. */
  public volatile ArrayList<Double> collectedTorque = new ArrayList<Double>();
  ...
  public void run() {
    ...
    while (true) {
      ...
      aveTorque = (leftTorque + rightTorque) / 2;
      
      if (FindAndPushBox.isPushing == true && leftTorque > 0.07 && rightTorque > 0.07) {
        collectedTorque.add(aveTorque);
      }
